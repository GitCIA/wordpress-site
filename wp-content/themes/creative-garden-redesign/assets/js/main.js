(function ($) {
  ...
  */
  ...
  /*--------------------------------------------------------------
    6. Gallery Slider Pagination
  --------------------------------------------------------------*/
  function gallerySliderInit() {
    if ($.exists('.cs_gallery_slider')) {
      $('.cs_gallery_slider').each(function () {
        var $slider = $(this);
        ...
        $container.find('.cs_left_arrow').on('click', function() {
    ...
    if ($.exists('.cs_video_open')) {
      ...
      function getEmbedUrl(url) {
        ...
        if (url.includes('youtu.be/')) {
          ...
          videoId = url; // It's just the video ID
        }
      ...
      $(document).on('click', '.cs_video_open', function (e) {
        ...
        $('.cs_video_popup-container iframe').attr('src', embedUrl);
